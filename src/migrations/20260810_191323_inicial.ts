...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "produtos_tags" ADD CONSTRAINT "produtos_tags_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."produtos"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "produtos_tags_order_idx" ON "produtos_tags" USING btree ("_order");
  CREATE INDEX "produtos_tags_parent_id_idx" ON "produtos_tags" USING btree ("_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  await db.execute(sql`
   DROP TABLE "produtos_tags" CASCADE;
